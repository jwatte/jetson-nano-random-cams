...
$(NAME):	setup $(OBJFILES)
	g++ -o "$(NAME)" -g -Wall -Werror $(OBJFILES) -L /usr/local/cuda/targets/aarch64-linux/lib -lfltk -lpthread -ljetson-inference -ljetson-utils -lcuda -lcudart -lcpr -lfltk
...
obj/%.o:	%.cpp
	@mkdir -p obj
	g++ -MMD -c -std=c++14 -g -Wall -Werror -I /usr/local/cuda/targets/aarch64-linux/include -o $@ $<
